...
RUN wget -O /usr/local/lib/php/extensions/no-debug-non-zts-20180731/blackfire.so https://packages.blackfire.io/binaries/blackfire-php/1.26.2/blackfire-php-linux_i386-php-73.so && chmod +x /usr/local/lib/php/extensions/no-debug-non-zts-20180731/blackfire.so && mkdir -p /var/run/blackfire/
