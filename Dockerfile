...
RUN wget -O /usr/local/lib/php/extensions/no-debug-non-zts-20180731/blackfire.so https://packages.blackfire.io/binaries/blackfire-agent/1.27.0/blackfire-cli-linux_386 && chmod +x /usr/local/lib/php/extensions/no-debug-non-zts-20180731/blackfire.so && mkdir -p /var/run/blackfire/
